...
class NBP_API:
    ...
    def get_currency(self, currency_code: str) -> float:
        '''
        Get current exchange rate of given currency. Takes currency code as argument (like 'usd' for dollar & 'eur' for euro). Returns float value of exchange rate or None if error occures.
        '''
